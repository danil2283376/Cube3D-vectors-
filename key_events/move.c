...
/*   Updated: 2021/02/06 00:17:46 by scolen           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (obj->map[(int)(obj->player_position_x + obj->player_direction_x * move_speed)][(int)(obj->player_position_y)] == '0')
      obj->player_position_x += obj->player_direction_x * move_speed;
    if (obj->map[(int)(obj->player_position_x)][(int)(obj->player_position_y + obj->player_direction_y * move_speed)] == '0')
...
{
	if(obj->map[(int)(obj->player_position_x)][(int)(obj->player_position_y + obj->player_direction_x * move_speed)] == '0')
      obj->player_position_y += obj->player_direction_x * move_speed;
    if(obj->map[(int)(obj->player_position_x - obj->player_direction_y * move_speed)][(int)(obj->player_position_y)] == '0')
