...
/*   Updated: 2021/02/06 22:43:30 by scolen           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	objects->sprite_height = abs(
			(int)(objects->s_value_from_map.resolution_y
				/ (objects->transform_pos_y)));
	objects->start_sprite_y = -objects->sprite_height
		/ 2 + objects->s_value_from_map.resolution_y / 2;
	if (objects->start_sprite_y < 0)
		objects->start_sprite_y = 0;
	objects->end_sprite_y = objects->sprite_height
		/ 2 + objects->s_value_from_map.resolution_y / 2;
...
{
	objects->width_sprite = abs((int)
			(objects->s_value_from_map.resolution_y
			/ (objects->transform_pos_y)));
	objects->start_sprite_x = -objects->width_sprite
		/ 2 + objects->screen_pos_x;
